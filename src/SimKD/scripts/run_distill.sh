...
python train_student.py --path_t ./save/teachers/models/resnet38x2_vanilla_cifar100_trial_1/resnet38x2_best.pth --distill simkd --model_s resnet8x4 -c 0 -d 0 -b 1 --trial 0 --gpu_id 0
python train_student.py --path_t ./save/teachers/models/resnet38x2_vanilla_cifar100_trial_1/resnet38x2_best.pth --distill simkd --model_s MobileNetV2 -c 0 -d 0 -b 1 --trial 0 --gpu_id 0

# ImageNetsMobileNetV2
